...
import com.dspot.declex.action.model.ModelsActionHandler;
...
import com.dspot.declex.override.handler.ItemSelectHandler;
...
public class DeclexCorePlugin extends AndroidAnnotationsPlugin {
	...
	public List<AnnotationHandler<?>> getHandlers(AndroidAnnotationsEnvironment androidAnnotationEnv) {
		...
		ActionHandler.addPlugin(new ModelsActionHandler());
