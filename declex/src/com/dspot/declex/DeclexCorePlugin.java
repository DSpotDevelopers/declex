...
public class DeclexCorePlugin extends AndroidAnnotationsPlugin {
	...
	public List<AnnotationHandler<?>> getHandlers(AndroidAnnotationsEnvironment androidAnnotationEnv) {
		...
		annotationHandlers.add(new ExportedHandler(androidAnnotationEnv));
		annotationHandlers.add(new ExportedPopulateHandler(androidAnnotationEnv));
		annotationHandlers.add(new ExportedRecollectHandler(androidAnnotationEnv));
