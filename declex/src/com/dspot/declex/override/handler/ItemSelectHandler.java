...
import com.dspot.declex.event.holder.ItemSelectHolder;
import com.dspot.declex.event.holder.ViewListenerHolder;
import com.dspot.declex.share.holder.ViewsHolder;
import com.helger.jcodemodel.AbstractJClass;
import com.helger.jcodemodel.IJExpression;

public class ItemSelectHandler extends BaseViewListenerHandler {
	...
	protected ViewListenerHolder getListenerHolder(String elementName,
		...
		return holder.getPluginHolder(new ItemSelectHolder(holder));
	}
}
