...
public class PutOnEventHandler extends BaseOnEventHandler {

	public PutOnEventHandler(AndroidAnnotationsEnvironment environment) {
		super(PutOnEvent.class, environment);
	}
	...
	public void validate(Element element, ElementValidation valid) {
		...
		if (element.getAnnotation(PutOnEvent.class).debug()) {
